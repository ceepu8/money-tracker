...
export const NUMBER_FILTER_TEXT = {
  [NUMBER_FILTER_TYPE.EQUAL]: <>&#61;</>,
  [NUMBER_FILTER_TYPE.NOT_EQUAL]: <>&#8800;</>,
  [NUMBER_FILTER_TYPE.GREATER_THAN]: <>&#62;</>,
  [NUMBER_FILTER_TYPE.LESS_THAN]: <>&#60;</>,
  [NUMBER_FILTER_TYPE.GREATER_THAN_OR_EQUAL_TO]: <>&#8805;</>,
  [NUMBER_FILTER_TYPE.LESS_THAN_OR_EQUAL_TO]: <>&#8804;</>,
  [NUMBER_FILTER_TYPE.IS_EMPTY]: 'Is empty',
  [NUMBER_FILTER_TYPE.IS_NOT_EMPTY]: 'Is not empty',
}

export const SELECT_FILTER_TEXT = {
  [SELECT_FILTER_TYPE.IS]: 'Is',
  [SELECT_FILTER_TYPE.IS_NOT]: 'Is not',
  [SELECT_FILTER_TYPE.IS_EMPTY]: 'Is empty',
  [SELECT_FILTER_TYPE.IS_NOT_EMPTY]: 'Is not empty',
}
